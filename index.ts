...
const T: Record<Lang, Record<string, string>> = {
  az: {
    ...
    apiKeyLink: '    Pulazsiz almaq ucun → https://console.groq.com',
    enterApiKey: 'API Acari daxil et: ',
    apiKeyEmpty: '✖  API acari olmadan islemez.',
    apiKeySaved: '✔  API acari saxlanildi. Bir daha sorulmayacaq.',
    apiKeyInvalid: '✖  API acari yanlisdir.',
    apiKeyReset: '   Yeniden baslatılır... Yeni acar daxil etmek ucun programi yeniden calistir.',
    noStaged: '⚠   Stage edilmis deyisiklik yoxdur.',
    stagedHint: '    Evvel: git add .',
    noGit: '✖  Git deposu tapilmadi.',
    generating: '⚡  AI commit mesajlari hazirlayir...',
    noMessages: '✖  Mesaj yaradila bilmedi. Yeniden calis.',
    ...
    langEn: 'Ingilisce',
    langTr: 'Turkce',
    resetKey: '🔑  API acari sifirlamaq ister misiniz? (b/x): ',
    resetYes: 'b',
  ...
  tr: {
    ...
    generating: '⚡  AI commit mesajlarını hazırlıyor...',
